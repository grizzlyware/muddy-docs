...
4. In **Name** **(1)**, type a name that helps you recognise it, such as **Website shop**. Only you see this. If you leave it blank, Muddy calls it **Shop**.
5. Under **Component type**, click **Shop** **(2)**. If **Shop** isn't there, your shop isn't open yet (see [Before you start](#before-you-start)).
6. Choose how your shop looks. Each setting is explained in [Choosing how your shop looks](#choosing-how-your-shop-looks).
7. Click **Create component** **(3)**.

![The Create embeddable component form, with Shop chosen as the component type](../screenshots/shop-k1-create-shop-component-1790281845435.png)
...
![The look settings for a new shop component, as Muddy first sets them](../screenshots/shop-k2-shop-look-settings-1790281847869.png)
...
![The Embeddable components page, with Copied! on the shop component's button](../screenshots/shop-k4-copied-1790282945576.png)
...
![The Payment domains page](../screenshots/shop-k5-payment-domains-add-1790282131840.png)
