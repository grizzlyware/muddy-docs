...
tags:
  ...
  - stock
order: 40
description: Learn how to record how many of each product you have, so customers can't buy things you've run out of.
pinned: false
---
...
When this happens, your stock goes below zero (shown in red), and you get an email called **Not enough stock to fulfil order**. You can then decide what to do. You might find another one, or contact the customer and cancel their order, which refunds them in full.
