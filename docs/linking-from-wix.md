...
![Website embedding in settings](../screenshots/step-one-BDkEykKR.webp)

2. Find the booking form you want to link to and copy the **hosted booking form URL**

![Copying the hosted booking form URL](../screenshots/wix-step-two-BE7-HdsI.webp)
...
![Wix dashboard](../screenshots/wix-step-three-DZP324ul.webp)

### Step 2: Add a new section

Add a new section to your page where you'd like the button to appear.

![Adding a new section](../screenshots/wix-step-four-DcqMv5wY.webp)

### Step 3: Add an element

Add a new element to the section.

![Adding a new element](../screenshots/wix-step-five-CFirK9kR.webp)

### Step 4: Choose a button

Select a **Button** style that fits your site.

![Choosing a button style](../screenshots/wix-step-six-BwRs9sop.webp)

### Step 5: Set the link

Open the button settings and find the link options.

![Button link settings](../screenshots/wix-step-seven-BgiCL7ym.webp)

Paste your booking form URL into the address field.

![Pasting the booking form URL](../screenshots/wix-step-eight-CCigbjBs.webp)

### Step 6: Publish your site

Click **Publish** to make your changes live.

![Publishing the site](../screenshots/wix-step-nine-BbrJk26l.webp)

Your customers can now click the button to open your booking form.

![Finished booking button on Wix](../screenshots/wix-step-ten-BJGIqNph.webp)
