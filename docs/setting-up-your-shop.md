...
category: Shop
category_description: Sell products and gift cards on your own website, alongside your bookings.
tags:
  - shop
  - settings
  - website
order: 10
description: Learn what the shop does, what to set up before you open it, and how to open, close and preview it.
pinned: false
---
...
To get there, click **Shop** in the left-hand menu. It sits in the **Payments** section, below **Vouchers** and **Loyalty points**.

## The shop page

The **Shop** page is your starting point. At the top you'll see a few figures:
...
- **Delivery** — how orders reach customers, and what that costs.
...
1. **Add your products.** Give each one a name, a price and a photo. See *Adding products and variants*.
2. **Group them into collections.** This is optional, but it makes your shop front much easier to browse. See *Organising your shop with collections*.
3. **Set your stock**, if you want Muddy to stop selling things when they run out. See *Tracking stock*.
...
2. Click **Preview your shop** at the top of the page.

Your shop opens in a new tab. A banner at the top reminds you that you're previewing, and shows pages customers may not be able to see yet. The preview lasts 30 minutes, then you'll need to click **Preview your shop** again.

Once your shop is open, the same button says **View your shop** instead.
